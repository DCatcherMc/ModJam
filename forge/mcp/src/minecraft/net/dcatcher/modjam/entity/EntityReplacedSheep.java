...
public class EntityReplacedSheep extends EntityAnimal implements IShearable
{
    ...
    public EntityReplacedSheep func_90015_b(EntityAgeable par1EntityAgeable)
    {
        EntityReplacedSheep entitysheep = (EntityReplacedSheep)par1EntityAgeable;
        EntityReplacedSheep entitysheep1 = new EntityReplacedSheep(this.worldObj);
    ...
    private int func_90014_a(EntityAnimal par1EntityAnimal, EntityAnimal par2EntityAnimal)
    {
        ...
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.field_90016_e, ((EntityReplacedSheep)par1EntityAnimal).worldObj);
        int k;
    ...
    {
        return 15 - ((EntityReplacedSheep)par1EntityAnimal).getFleeceColor();
    }
