...
public class ModelSheep1 extends ModelQuadruped
{
    ...
    public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        ...
        this.head.rotationPointY = 6.0F + ((EntityReplacedSheep)par1EntityLivingBase).func_70894_j(par4) * 9.0F;
        this.field_78152_i = ((EntityReplacedSheep)par1EntityLivingBase).func_70890_k(par4);
    }
