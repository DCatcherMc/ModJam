package net.dcatcher.modjam.entity.bat;
...
public class RenderReplacedBat extends RenderLiving
{
    ...
    protected ResourceLocation func_110834_a(EntityReplacedBat par1EntityBat)
    {
        return field_110835_a;
    }

    protected void func_82442_a(EntityReplacedBat par1EntityBat, float par2)
    {
        GL11.glScalef(0.35F, 0.35F, 0.35F);
    }

    protected void func_82445_a(EntityReplacedBat par1EntityBat, double par2, double par4, double par6)
    {
        super.renderLivingAt(par1EntityBat, par2, par4, par6);
    }

    protected void func_82444_a(EntityReplacedBat par1EntityBat, float par2, float par3, float par4)
    {
    ...
    {
        this.func_82443_a((EntityReplacedBat)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.func_82442_a((EntityReplacedBat)par1EntityLivingBase, par2);
    }

    protected void rotateCorpse(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        this.func_82444_a((EntityReplacedBat)par1EntityLivingBase, par2, par3, par4);
    }
    ...
    {
        this.func_82445_a((EntityReplacedBat)par1EntityLivingBase, par2, par4, par6);
    }
    ...
    {
        this.func_82443_a((EntityReplacedBat)par1EntityLivingBase, par2, par4, par6, par8, par9);
    }

    protected ResourceLocation func_110775_a(Entity par1Entity)
    {
        return this.func_110834_a((EntityReplacedBat)par1Entity);
    }
    ...
    {
        this.func_82443_a((EntityReplacedBat)par1Entity, par2, par4, par6, par8, par9);
    }
}
