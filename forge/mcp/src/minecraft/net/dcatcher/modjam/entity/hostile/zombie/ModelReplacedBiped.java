...
public class ModelReplacedBiped extends ModelBase
{
    ...
    public ModelReplacedBiped()
    {
        this(0.0F);
    }

    public ModelReplacedBiped(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModelReplacedBiped(float par1, float par2, int par3, int par4)
    {
