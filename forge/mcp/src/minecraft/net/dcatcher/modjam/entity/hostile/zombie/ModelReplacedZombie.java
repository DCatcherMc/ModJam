...
public class ModelReplacedZombie extends ModelBiped
{
    public ModelReplacedZombie()
    {
        this(0.0F, false);
    }

    protected ModelReplacedZombie(float par1, float par2, int par3, int par4)
    {
        super(par1, par2, par3, par4);
    }

    public ModelReplacedZombie(float par1, boolean par2)
    {
